...
<meta name="description" content="A description of the page"/>
	<body align="center">
		<div class="ui fluid form segment" style="background-color:rgba(192,192,192,.5)">
			<label>
				<h1 style="color:white; text-align: center;">Earth-Puzzle</h1>
			</label>	
			<div class="ui icon header">
				Your score is
				<i class="circular icon"><?= $this->session->userdata("score")?></i>
			</div><br/>
			<a href="<?= base_url()?>index.php/score/restart" class="ui button red" style="text-decoration:none;" id="">
				Try again
			</a>
			<a href="#" id="share">
				<div style="background-color:#4c66a4" class="ui labeled icon button facebook">
					<i style="background-color:#4c66a4" class="icon facebook"></i>
					Share with facebook
				</div>
			</a>	
